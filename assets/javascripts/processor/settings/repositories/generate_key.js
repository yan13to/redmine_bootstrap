...
export default function SettingsRepositoriesGenerateKey(currentElement) {
  currentElement.addEventListener('click', function(e) {
    e.preventDefault();

    const settings_mail_handler_api_key = document.getElementById('settings_sys_api_key');
